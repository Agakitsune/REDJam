...
class OriginSprite
    ...
    def render(x: @x, y: @y, width: (@width || @clip_width), height: (@height || @clip_height),
                ...
                originY: @originY)
    update
    vertices = OriginVertices.new(x, y, width, height, rotate, originX: originX, originY: originY, crop: crop, flip: flip)
    vertices.noRotate(@noRotate)
