class GameOverState
    def initialize
        ...
        replay_box = Rectangle.new(width: 200, height: 40, y: (Window.height / 2) + 80, color: 'yellow')
        replay_box.x = ((Window.width - replay_box.width) / 2) - 200

        quit_box = Rectangle.new(width: 200, height: 40, y: (Window.height / 2) + 80, color: 'red')
